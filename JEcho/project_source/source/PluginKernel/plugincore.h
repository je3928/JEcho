...
public:
	...
	void updateParameters(double delaytimesync);
	double delayCalc(double BPM);
...
private:
	...
	double delaytime = 500.00000000;
	int sync = 0;
	enum class syncEnum { OFF, ON };
	int delaySetting = 0;
	enum class delaySettingEnum { Full, FullD, FullT, Half, HalfD, HalfT, Quarter, QuarterD, QuarterT, Eighth, EighthD, EighthT, Sixteenth, SixteenthD, SixteenthT, Thirtytwo };
	double delayoffset = 0.00000000;
	double feedback = 50.00000000;
	double wet = 0.50000000;
	double gain = 0.00000000;
	double saturation = 0.000000000;
	int satbypass = 0;
	enum class satbypassEnum { OFF, ON };
	double fc = 1000.000000000;
	double drivevolume = -30.00000000;


	int branchlessbypass[2] = { 1, 0 };

	CircularBuffer<double> BufferL;
	CircularBuffer<double> BufferR;

	//ClassATubePre tubepre;
	//ClassATubePreParameters preparams; 
	...
	int delayoffsetsamples = 0;
	int delaysamplesright = 0;
	double gaincooked = 0.0000000;
	double saturationcooked = 0.00000000;
	double drivevolumecooked = 0.0000000;
